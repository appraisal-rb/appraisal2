...
# appraisal2 Rakefile v7.1.13 - 2026-08-30
...
# rake install                                # Build and install appraisal2-1.0.0.gem in...
# rake install:local                          # Build and install appraisal2-1.0.0.gem in...
# rake kettle:jem:install                     # Internal target used by `kettle-jem install`
# rake kettle:jem:selftest                    # Self-test: template appraisal2 against itse...
