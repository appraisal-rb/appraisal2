...
gem_version =
  if Gem.ruby_version >= Gem::Version.new("3.1")
    ...
    Module.new.tap { |mod| Kernel.load("#{__dir__}/lib/appraisal/version.rb", mod) }::Appraisal::Version::VERSION
  else
...
Gem::Specification.new do |spec|
  ...
  spec.metadata["homepage_uri"] = "https://appraisal2.galtzo.com"
  ...
  spec.metadata["mailing_list_uri"] = "https://www.rubyforum.org/tag/appraisal2"
  ...
  spec.add_development_dependency("kettle-dev", "~> 3.0", ">= 3.0.18")             # ruby >= 2.4
